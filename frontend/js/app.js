...
const I18N = {
  en: {
    ...
    footer_explorers:"Explorers",footer_faq:"FAQ",footer_api_spec:"API Spec",footer_exchange_analysis:"Exchange Analysis",explorer_title:"Top 10 Solana Blockchain Explorers",explorer_desc:"Global leading Solana blockchain explorers and data query platforms. Updated monthly with the latest features and stats.",explorer_monthly:"Monthly update",
  ...
  zh: {
    ...
    footer_explorers:"浏览器",footer_faq:"常见问题",footer_api_spec:"API文档",footer_exchange_analysis:"兑换分析",explorer_title:"Solana链前10大区块链浏览器",explorer_desc:"全球领先的Solana区块链浏览器和数据查询平台。每月更新最新功能和数据。",explorer_monthly:"每月更新",
  ...
  es: {
    ...
    footer_explorers:"Exploradores",footer_faq:"Preguntas Frecuentes",footer_api_spec:"API Documentacion",footer_exchange_analysis:"Analisis de Intercambio",explorer_title:"Top 10 Exploradores de Blockchain Solana",explorer_desc:"Exploradores de blockchain Solana lideres mundiales y plataformas de consulta de datos. Actualizados mensualmente.",explorer_monthly:"Actualizacion mensual",
  ...
  ar: {
    ...
    footer_explorers:"المستكشفون",footer_faq:"الأسئلة الشائعة",footer_api_spec:"مواصفات API",footer_exchange_analysis:"تحليل التبادل",explorer_title:"أفضل 10 مستكشفي بلوكشين سولانا",explorer_desc:"منصات استكشاف بلوكشين سولانا الرائدة عالمياً. تحديث شهري.",explorer_monthly:"تحديث شهري",
  ...
  fr: {
    ...
    footer_explorers:"Explorateurs",footer_faq:"FAQ",footer_api_spec:"Spec API",footer_exchange_analysis:"Analyse des Echanges",explorer_title:"Top 10 Explorateurs Blockchain Solana",explorer_desc:"Explorateurs blockchain Solana leaders mondiaux. Mise a jour mensuelle.",explorer_monthly:"Mise a jour mensuelle",
  ...
  ru: {
    ...
    footer_explorers:"Эксплореры",footer_faq:"ЧаВо",footer_api_spec:"Спецификация API",footer_exchange_analysis:"Анализ Обмена",explorer_title:"Топ-10 эксплореров блокчейна Solana",explorer_desc:"Ведущие эксплореры блокчейна Solana. Ежемесячное обновление.",explorer_monthly:"Ежемесячное обновление",
