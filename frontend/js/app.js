...
const I18N = {
  en: {
    ...
    footer_explorers:"Explorers",explorer_title:"Top 10 Solana Blockchain Explorers",explorer_desc:"Global leading Solana blockchain explorers and data query platforms. Updated monthly with the latest features and stats.",explorer_monthly:"Monthly update",
  ...
  zh: {
    ...
    footer_explorers:"浏览器",explorer_title:"Solana链前10大区块链浏览器",explorer_desc:"全球领先的Solana区块链浏览器和数据查询平台。每月更新最新功能和数据。",explorer_monthly:"每月更新",
  ...
  es: {
    ...
    footer_explorers:"Exploradores",explorer_title:"Top 10 Exploradores de Blockchain Solana",explorer_desc:"Exploradores de blockchain Solana lideres mundiales y plataformas de consulta de datos. Actualizados mensualmente.",explorer_monthly:"Actualizacion mensual",
  ...
  ar: {
    ...
    footer_explorers:"المستكشفون",explorer_title:"أفضل 10 مستكشفي بلوكشين سولانا",explorer_desc:"منصات استكشاف بلوكشين سولانا الرائدة عالمياً. تحديث شهري.",explorer_monthly:"تحديث شهري",
  ...
  fr: {
    ...
    footer_explorers:"Explorateurs",explorer_title:"Top 10 Explorateurs Blockchain Solana",explorer_desc:"Explorateurs blockchain Solana leaders mondiaux. Mise a jour mensuelle.",explorer_monthly:"Mise a jour mensuelle",
  ...
  ru: {
    ...
    footer_explorers:"Эксплореры",explorer_title:"Топ-10 эксплореров блокчейна Solana",explorer_desc:"Ведущие эксплореры блокчейна Solana. Ежемесячное обновление.",explorer_monthly:"Ежемесячное обновление",
